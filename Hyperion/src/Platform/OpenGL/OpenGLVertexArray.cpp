...
namespace Hyperion
{
    ...
    void OpenGLVertexArray::AddVertexBuffer(const Hyperion::Ref<VertexBuffer>& vertexBuffer)
    {
    ...
    void OpenGLVertexArray::SetIndexBuffer(const Hyperion::Ref<IndexBuffer>& indexBuffer)
    {
        glBindVertexArray(m_RendererID);
        indexBuffer->Bind();
